...
public class Method03Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("평균 = " + calcAgv(calcTotal(korean, english, math)));
		
		
		// calcGrade() 메소드를 정의+호출 하여 학점(A, B, C, D, F)을 출력
		// 평균 90 이상이면 A, 80 이상이면 B, 70 이상이면 C, 60 이상이면 D
		// 나머지는 F
		System.out.println("학점 = " + calcGrade(calcAgv(calcTotal(korean, english, math))));
	...
	public static double calcAgv(int total) {
