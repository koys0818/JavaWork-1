...
public class AjaxWriteList extends AjaxWriteResult {
	...
	public AjaxWriteList(int count, String status, String message, List<WriteDTO> list, int page, int totalPage,
			int totalCnt, int writePages, int pageRows) {
		super(count, status, message);
		this.list = list;
		this.page = page;
