...
public class RegExp01Main {
	...
	public static void main(String[] args) {
		...
		pat = Pattern.compile(regex); // Patter 객체 생성
		...
		if(Pattern.matches("My....", "Myabcd")) {
			System.out.println("Pattern.maches() 매칭 OK");
		} else {
			System.out.println("Pattern.maches() 매칭 FAIL");
		}
		...
		input = "-My98KK-myABCD--My1234597__MyZZ---My789";
