...
//		String afterSpl = String.join("", strings);
//		System.out.println(afterSpl);
//		
//		StringTokenizer token7 = new StringTokenizer(afterSpl, "+-/*()", true);
//		while(token7.hasMoreTokens()) {
//			System.out.println(token7.nextToken());
//		}
