...
public class DateTime01Main {
	...
	public static void main(String[] args) throws Exception{
		...
		long durationInMillls = 1000003;
		long millis = durationInMillls % 1000;
		long sec = (durationInMillls / (1000 * 60)) % 60;
		long min = (durationInMillls / 1000) % 60;
		long hr = (durationInMillls / (1000 * 60 * 60)) % 24;
